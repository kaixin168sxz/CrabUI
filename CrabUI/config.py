...
i2c_freq = const(800_000)
display_sda = 17
display_scl = 21

# spi display
use_spi = const(False)
hardware_spi = const(2)  # spi id号
...
# 在指定帧数内到达目的地
default_speed = const(7)
camera_speed = const(6)
selector_speed = const(7)
expand_speed = const(6)
...
checkbox_yoffset = const(half_list_item_space+5)
